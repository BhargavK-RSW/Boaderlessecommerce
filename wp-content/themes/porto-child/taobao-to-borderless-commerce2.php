...
$itemId = (isset($itemId)) ? $itemId : 623346006409;
	             ...
	             if(empty($shipp_cost) || $shipp_cost < 1){
                    ...
                    foreach($config_items as $ci){
                        ...
                        foreach($ci['Configurators']['ValuedConfigurator'] as $c){
                            $customid=$customid.$c['@attributes']['Vid'];
                        }
                        if($promoconfig){
                            ...
                            if($ci['Id']==$pci['Id']){
                               ...
                               echo '<input type="hidden" id="'.$customid.'" data-price="'.$original1_amount.'" data-promo-price="'.$promo1_amount.'" data-quantity="'.$ci['Quantity'].'">'; 
                            }
                            ...
                            echo '<input type="hidden" id="'.$customid.'" data-price="'.$original1_amount.'" data-quantity="'.$ci['Quantity'].'">';
...
$xmlp='<SearchItemsParameters><Provider>Taobao</Provider><SearchMethod>Extended</SearchMethod><ItemTitle>'.$url1.'</ItemTitle><UseOptimalFrameSize>true</UseOptimalFrameSize></SearchItemsParameters>';
...
$itemInfo = $xmlObject->Result->Item;
	...
	<form id="searchform" class="searchform" action="http://aliexpress.djbanjara.com/taobao-to-borderless-commerce/" method="get">
	...
	<div class="product-inner">
		...
		<div class="product-image">
			...
			<a href="http://aliexpress.djbanjara.com/taobao-to-borderless-commerce/?url=https%3A%2F%2Fworld.taobao.com%2Fitem%2F<?php echo $itml['Id']; ?>.htm%3Fspm%3Da21wu.10013406-cat-tw.0.0.28e25116D0Opvd">
				<div class="inner"><img width="" src="<?php echo $itml['MainPictureUrl'];?>" class="external-img wp-post-image " alt="<?php echo $itml['OriginalTitle'];?>"></div>		</a>
				<div class="links-on-image">
				<div class="add-links-wrap">
		<div class="add-links clearfix">
			<a href="" data-quantity="1" class="viewcart-style-2 button product_type_simple add_to_cart_button ajax_add_to_cart"   aria-label="<?php echo $itml['OriginalTitle'];?>" rel="nofollow">Add to cart</a>
			</div>
		</div>
			</div>
			</div>
		...
		<h3 class="woocommerce-loop-product__title"><?php echo $itml['OriginalTitle'];?></h3>	</a>
...
if($from>$itemperpage)
{
	$from_p = $from-$itemperpage;
		...
		$from_p = 0;
			...
			$paginationURL = 'http://aliexpress.djbanjara.com/taobao-to-borderless-commerce/?from='.$from.'&url='.$url;
			$paginationURL_n = 'http://aliexpress.djbanjara.com/taobao-to-borderless-commerce/?from='.$from_n.'&url='.$url;
			$paginationURL_p = 'http://aliexpress.djbanjara.com/taobao-to-borderless-commerce/?from='.$from_p.'&url='.$url;
	 ?>
		...
		<div class="pagination">
		  ...
		  <a href="<?php echo $paginationURL_p;?>">&laquo;</a>
			...
			echo	'<a href="http://aliexpress.djbanjara.com/taobao-to-borderless-commerce/?from='.$from1.'&url='.$url.'" class="'.$class.'">'.$i.'</a>';
