   ...
   <?php
             ...
             <label for="product_consolidation"> Product Consolidation</label> <label data-price="0" class="additionalcostcheckbox" style="color:red;padding-left:30px"  id="product_cons_amount"></label><br>
                    <div id="aliexpress-shipping-methods">
                        ...
                        <h6>Step 1: Need to pay for Product price and service charges.</h6>
                        <h6>Step 2: Wait between 1-3 weeks for a second quotation for your shipping after products are measured and weighed.</h6>
                        <hr>
                    <!--
                    ...
                    <div id="productloader1" class="my-2 d-none"><img src="http://borderlesscommerce.net/wp-content/uploads/2020/09/loader50px.gif" alt="ali243 product loader"></div>
										<div id="productloader2" class="my-2 d-none"><img src="http://borderlesscommerce.net/wp-content/uploads/2020/09/loader50px.gif" alt="ali243 product loader"></div>
								</div>
            </div>
<?php
/*
...
var pro_ins_checkBox = document.getElementById("product_inspection_check");
	  if (pro_ins_checkBox.checked == true){
	     ...
	     var product_inspecton_value= (Number(actual_amount) * Number(pif) * Number(productQuantity)).toFixed(2);
...
var pro_cons_checkBox = document.getElementById("product_consolidation_check");
	  if (pro_cons_checkBox.checked == true){
	     // newproductpricepromo=Number(productpricepromo) + Number(actual_amount) * Number(pif);
	     var product_consolidation_value= (Number(actual_amount) * Number(pcf) * Number(productQuantity)).toFixed(2);
