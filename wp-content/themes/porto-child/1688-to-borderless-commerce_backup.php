   ...
   <?php
             ...
             <label for="product_consolidation"> Product Consolidation</label> <label data-price="0" class="additionalcostcheckbox" style="color:red;padding-left:30px"  id="product_cons_amount"></label><br>
                    <div id="aliexpress-shipping-methods">
                        ...
                        Click <a href="https://borderlesscommerce.net/shipping-estimates/">here</a> to get an estimate.
                        <hr>
                    <!--
...
// var txt = txt + "<br/> SKU: " + sku_custom_id + "<br/> Ship by: " + shippingcompany;
  ...
  imagelink=linkforimg;  
    ...
    if(imagelink==null ){ imagelink = "<?php echo $itemInfo['MainPictureUrl'];?>";}  
      ...
      var str = "price=" + toatalPrice + "&quantity=" + productQuantity + "&title=" + producttitle2 + "&link=" + productlink + "&content=" + txt + "&image=" + imagelink + "&attributes=" + propattribute + "&consoins=" + conso_ins;
...
// var txt = txt + "<br/> SKU: " + sku_custom_id + "<br/> Ship by: " + shippingcompany;
  var txt = txt + "<br/> SKU: " + sku_custom_id;
      ...
      var str = "price=" + toatalPrice + "&quantity=" + productQuantity + "&title=" + producttitle2 + "&link=" + productlink + "&content=" + txt + "&image=" + imagelink + "&consoins=" + conso_ins;   
...
$xmlp='<SearchItemsParameters><Provider>Alibaba1688</Provider><SearchMethod>Extended</SearchMethod><IsClearItemTitles>false</IsClearItemTitles><ItemTitle>'.$url1.'</ItemTitle></SearchItemsParameters>';
